...
🌻 Latte</su
``` {r echo = F}
  p1_npg <- p1 + scale_color_catppuccin(palettes = "latte")
  p2_npg <- p2 + scale_fill_catppuccin(palettes = "latte")
...
``` {r echo = F}
  p1_npg <- p1 + scale_color_catppuccin(palettes = "frappe")
  p2_npg <- p2 + scale_fill_catppuccin(palettes = "frappe")
  grid.arrange(p1_npg, p2_npg, ncol = 2)
```
...
``` {r echo = F}
  p1_npg <- p1 + scale_color_catppuccin(palettes = "macchiato")
  p2_npg <- p2 + scale_fill_catppuccin(palettes = "macchiato")
  grid.arrange(p1_npg, p2_npg, ncol = 2)
```
...
``` {r echo = F}
  p1_npg <- p1 + scale_color_catppuccin(palettes = "mocha")
  p2_npg <- p2 + scale_fill_catppuccin(palettes = "mocha")
  grid.arrange(p1_npg, p2_npg, ncol = 2)
```
